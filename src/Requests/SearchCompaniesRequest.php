...
class SearchCompaniesRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/crm/v3/objects/companies/search';
    }
    ...
    public function createDtoFromResponse(Response $response): SearchCompaniesResponse
    {
        /** @var array{total: int, results: list<array<string, mixed>>, paging?: array<string, mixed>|null} $data */
        $data = $response->json();

        return SearchCompaniesResponse::fromArray($data);
    }
}
