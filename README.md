...
[Laravel Boost](https://github.com/laravel/boost)-style helpers live under [`resources/boost/`](resources/boost/): [`guidelines/core.blade.php`](resources/boost/guidelines/core.blade.php) and a skill at [`resources/boost/skills/saloon-api-sdk-boilerplate-development/SKILL.md`](resources/boost/skills/saloon-api-sdk-boilerplate-development/SKILL.md). The init script rewrites vendor/package slugs there and renames the skill folder to `{package-slug}-development`.
